...
public class ProductsController {
...

	{
		...
		Watches watches = new Watches(watchDto.getWatchId(), watchDto.getBrandName(), watchDto.getWatchType(),
				watchDto.getBandType(), watchDto.getWaterResistant(), watchDto.getPrice());
	...
	public JSONObject updateWatch(@RequestBody WatchesDto watchDto, @PathVariable int watchId)

	{

		return productsServ.updateWatch(watchDto, watchId);
	...
	public JSONObject updateLaptops(@RequestBody LaptopsDto laptopDto, @PathVariable int laptopId)

	{

		return productsServ.updateLaptops(laptopDto, laptopId);
	...
	Tvs tv=new Tvs(tvDto.getTvId(),tvDto.getBrandName(),tvDto.getType(),tvDto.getDisplayType(),tvDto.getDisplaySize(),tvDto.getPrice()); 
